...
from Components import mainGraph, xAxis_dropdown_3D, yAxis_dropdown_3D, zAxis_dropdown_3D, faultFinder
from Components import xAxisText, yAxisText, zAxisText, sensorText, sensorDropdown, sensorHeader, labelDropdown, stat3, stat1, stat2, exportName, exportConfirm, AI_header, clusterMethod, reductionMethod
...
app.layout = html.Div(style={'background': 'linear-gradient(to bottom, blue, #000000)', 'height': '100vh', 'display': 'flex', 'justify-content': 'center', 'flex-direction': 'column', 'align-items': 'center'}, children=[
    ...
    html.Div(style={'width': '90%', 'height': '50%',  'background-color': 'white', },
        ...
        html.Div(style={'flex-direction': 'row', 'display': 'flex', 'width': '100%', 'height': '100%', 'overflow': 'hidden'}, children=[
