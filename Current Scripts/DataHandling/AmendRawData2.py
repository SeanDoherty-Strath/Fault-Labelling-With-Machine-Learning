...
if x == 'test':
    ...
    # No fault, 24 hours
    newDF = df2.iloc[:480, :]
    newDF = newDF._append(df.iloc[20:500], ignore_index=True)
    newDF = newDF._append(df2.iloc[500:980], ignore_index=True)
    newDF = newDF._append(df.iloc[520:1000], ignore_index=True)
    newDF = newDF._append(df2.iloc[1000:1480], ignore_index=True)
    newDF = newDF._append(df.iloc[1020:1500], ignore_index=True)
    ...
    filepath = Path('./UpdatedDataFebruary24.csv')
    newDF.to_csv(filepath)
