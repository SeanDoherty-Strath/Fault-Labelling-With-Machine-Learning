    ...
    for i in range(len(set(labels))):
        ...
        dropdowns.append(
            dcc.Dropdown(
                ...
                id=f'dropdown-{i}',
                options=[
                    {'label': 'No Fault (green)', 'value': 'green'},
                    {'label': 'Fault 1 (Red)', 'value': 'red'},
                    {'label': 'Fault 2 (orange)', 'value': 'orange'},
                    {'label': 'Fault 2 (yellow)', 'value': 'yellow'}]
            )
        )
    for i in range(len(set(labels)), 11):
        print(i)
        dropdowns.append(
