...
# Top
title = html.H1(children='Fault Labeller', style={'fontsize':100, 'color':'white', 'fontWeight':'bold', 'textAlign':'left', 'fontFamily':''})
...
# Box 1
sensorDropdown = dcc.Checklist(options=data.columns, style={'fontsize':18, 'fontFamily':'Comic Sans MS'}, inline=True, labelStyle={'width':'50%'})
sensorHeader = dcc.Markdown(children='Sensors', style={'fontsize':30, 'fontWeight':'bold', 'textAlign':'center', 'fontFamily':'Comic Sans MS'})
...
faultFinder = dcc.Dropdown(value='Unlabelled Data Point', options=['Unlabelled Data Point', 'No Fault', 'Fault 1', 'Fault 2', 'Fault 3'])



# Box 4
labelDropdown = dcc.Dropdown(value='No Fault', options=['Fault 1', 'Fault 2', 'Fault 3', 'No Fault'])
...
AI_header = dcc.Markdown('Auto Label', style={'fontSize':20, 'fontWeight':'bold', 'textAlign':'center',})
